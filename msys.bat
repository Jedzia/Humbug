...
set PATH=%PATH%;C:\Program Files\WinVICE;D:\E\Projects\C64\Game01;D:\E\Projects\C++\acm3\ACME\trunk\ACMEWithTweaks\tools\c64tools\win32;D:\E\Projects\C++\acm3\ACME\trunk\ACMEWithTweaks\msysbuild
set ACME=D:\E\Projects\C++\acm3\ACME\trunk\ACMEWithTweaks\ACME_Lib\
...
start %WD%sh --login -i 
REM --verbose 
REM -c cd /d/E/Projects/C++/C64/Dings
exit

...
{
    /** Brief description of $(fclass), on_entry
    ...
    /** Brief description of $(fclass), on_exit
     *  Detailed description.
     *  @param
     *  @param
     */
    ...
    struct Playing_ : public msm::front::state_machine_def<Playing_>
    {
        ...
        /** Brief description of $(fclass), start_prev_song
         *  Detailed description.
         *  @param
         */
    ...
    /** Brief description of $(fclass), open_drawer
     *  Detailed description.
     *  @param
     */
    void open_drawer(open_close const&)    { std::cout << "player::open_drawer\n"; }

    /** Brief description of $(fclass), close_drawer
     *  Detailed description.
     *  @param
     */
    void close_drawer(open_close const&)   { std::cout << "player::close_drawer\n"; }

    /** Brief description of $(fclass), store_cd_info
     *  Detailed description.
     *  @param cd TODO
     */
    void store_cd_info(cd_detected const& cd) { std::cout << "player::store_cd_info\n"; }

    /** Brief description of $(fclass), stop_playback
     *  Detailed description.
     *  @param
     */
    void stop_playback(stop const&)        { std::cout << "player::stop_playback\n"; }

    /** Brief description of $(fclass), pause_playback
     *  Detailed description.
     *  @param
     */
    void pause_playback(pause const&)      { std::cout << "player::pause_playback\n"; }

    /** Brief description of $(fclass), resume_playback
     *  Detailed description.
     *  @param
     */
    void resume_playback(end_pause const&)      { std::cout << "player::resume_playback\n"; }

    /** Brief description of $(fclass), stop_and_open
     *  Detailed description.
     *  @param
     */
    void stop_and_open(open_close const&)  { std::cout << "player::stop_and_open\n"; }

    /** Brief description of $(fclass), stopped_again
     *  Detailed description.
     *  @param
     */
...
/** Brief description of $(fclass), pstate
 *  Detailed description.
 *  @param p TODO
 */
inline void pstate(player const& p){
    std::cout << " -> " << state_names[p.current_state()[0]] << std::endl;
}

/** Brief description of $(fclass), test
 *  Detailed description.
 *
 */
inline void test(){
...
/** Brief description of $(fclass), mainX
 *  Detailed description.
 *  @return TODO
 */
inline int mainX(){

...
*/
/*---------------------------------------------------------*/
#ifndef HUMBUGGL_SCREENS_ZoomInScreen_H
#define HUMBUGGL_SCREENS_ZoomInScreen_H
 ...
 */
class ZoomInScreen : public gui::components::Screen {
public:

    /** Initializes a new instance of the <see cref="ZoomInScreen"/> class.
    *  Detailed description.
    *  @param loader File loading facility.
    *  @param background the background canvas used by this Screen.
    */
    ZoomInScreen(FileLoader& loader, gui::components::CCanvas* background);
    ~ZoomInScreen();
...
private:
    ...
    struct ZoomInScreenImpl;
    boost::scoped_ptr<ZoomInScreenImpl> pimpl_;
...
#endif // ifndef HUMBUGGL_SCREENS_ZoomInScreen_H

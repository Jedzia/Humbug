...
namespace humbug {
struct TutorA1::TutorA1Impl {
    //prv::EyeMover eyemover;
    //prv::WormMover wormmover;
    int x;
};

TutorA1::TutorA1( FileLoader& loader, CCanvas* background) :
    pimpl_(new TutorA1::TutorA1Impl ),
    Screen(background),
    m_Loader(loader),
    //m_iUpdateTimes(0),
    m_pScrollText(NULL),

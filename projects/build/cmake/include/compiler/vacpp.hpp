...
#if (__IBMCPP__ <= 600) || !defined(PLATFORM_STRICT_CONFIG)
...
#define PLATFORM_COMPILER "IBM Visual Age version " PLATFORM_STRINGIZE(__IBMCPP__)
...
#if __IBMCPP__ <= 1010
#define PLATFORM_NO_PARTIAL_SPECIALIZATION_IMPLICIT_DEFAULT_ARGS
#endif

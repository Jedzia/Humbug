...
//
// Helper macro PLATFORM_MSVC_FULL_VER for use in Boost code:
//
...
#  define PLATFORM_HAS_PRAGMA_DETECT_MISMATCH
#endif
//
...
//
#if _MSC_VER >= 1700
// # define PLATFORM_HAS_TR1_HASH			// don't know if this is true yet.
// # define PLATFORM_HAS_TR1_TYPE_TRAITS	// don't know if this is true yet.
...
#   elif _MSC_VER < 1800 
#     define PLATFORM_COMPILER_VERSION evc11 
#   elif _MSC_VER < 1900 
#     define PLATFORM_COMPILER_VERSION evc12
#   elif _MSC_VER < 2000  
#     define PLATFORM_COMPILER_VERSION evc14
#   else
#      if defined(PLATFORM_ASSERT_CONFIG)
#         error "Unknown EVC++ compiler version - please run the configure tests and report the results"
#      else
...
#   elif _MSC_VER < 1800 
#     define PLATFORM_COMPILER_VERSION 11.0
#   elif _MSC_VER < 1900
#     define PLATFORM_COMPILER_VERSION 12.0
#   elif _MSC_VER < 2000
#     define PLATFORM_COMPILER_VERSION 14.0
#   else

...
#if !__has_feature(cxx_exceptions) && !defined(PLATFORM_NO_EXCEPTIONS)
#  define PLATFORM_NO_EXCEPTIONS
#endif

#if !__has_feature(cxx_rtti) && !defined(PLATFORM_NO_RTTI)
#  define PLATFORM_NO_RTTI
#endif

#if !__has_feature(cxx_rtti) && !defined(PLATFORM_NO_TYPEID)
...
#if defined(__SIZEOF_INT128__) && !defined(PLATFORM_NVCC_CXX03) && !defined(_MSC_VER)
...
//
// The PLATFORM_FALLTHROUGH macro can be used to annotate implicit fall-through
...
#  define PLATFORM_COMPILER "Clang version " __clang_version__
#endif

...
#define PLATFORM_PLATFORM "Win32"
...
#if defined(__GNUC__) && !defined(PLATFORM_NO_SWPRINTF)
#  define PLATFORM_NO_SWPRINTF
#endif

//  Default defines for PLATFORM_SYMBOL_EXPORT and PLATFORM_SYMBOL_IMPORT
//  If a compiler doesn't support __declspec(dllexport)/__declspec(dllimport),
//  its boost/config/compiler/ file must define PLATFORM_SYMBOL_EXPORT and
//  PLATFORM_SYMBOL_IMPORT
#ifndef PLATFORM_SYMBOL_EXPORT
#  define PLATFORM_HAS_DECLSPEC
#  define PLATFORM_SYMBOL_EXPORT __declspec(dllexport)

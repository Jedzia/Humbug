...
MACRO(_PCH_GET_COMPILE_COMMAND out_command _input _output)
	...
	#SET(FUCK /Fp''${_native_output}'')
	#MESSAGE("FUCK ${FUCK}" )
	
		#SET(${out_command} 
		#	${CMAKE_CXX_COMPILER} ${_compile_FLAGS} /c /Fp\"${_native_output}\" /Yc\"${_native_input}\" pch_dummy.cpp
		#)	
		#SET(FUCK "${CMAKE_CXX_COMPILER} ${_compile_FLAGS} /c /Fp\"${_native_output}\" /Yc\"${_native_input}\" pch_dummy.cpp")	
		#SET(${out_command} ${CMAKE_CXX_COMPILER} ${_compile_FLAGS} /c /Fp\"${_native_output}\" /Fd\"${_native_output}.aaa.pdb\" /Yc\"${_native_input}\" pch_dummy.cpp)	
		SET(${out_command} ${CMAKE_CXX_COMPILER} ${_compile_FLAGS} /c /Fp\"${_native_output}\" /Fd\"d:/eigene dateien/templates/c++/cmake/qt4/build/single_pch/debug/single_pch.pdb\" /Yc\"${_native_input}\" pch_dummy.cpp)	
		#/out:${_output}
	#MESSAGE("FUCK ${FUCK}" )
...
MACRO(ADD_PRECOMPILED_HEADER _targetName _input)
  ...
  MESSAGE("CMAKE_CURRENT_SOURCE_DIR: ${CMAKE_CURRENT_SOURCE_DIR} _name: ${_name}")
  MESSAGE("_compile_FLAGS: ${_compile_FLAGS}")
  #message("COMMAND ${CMAKE_CXX_COMPILER}	${_compile_FLAGS} -x c++-header -o ${_output} ${_input}")
  SET_SOURCE_FILES_PROPERTIES(${CMAKE_CURRENT_BINARY_DIR}/${_name} PROPERTIES GENERATED 1)
  ADD_CUSTOM_COMMAND(
   OUTPUT	${CMAKE_CURRENT_BINARY_DIR}/${_name} 
   COMMAND ${CMAKE_COMMAND} -E copy_if_different  ${CMAKE_CURRENT_SOURCE_DIR}/${_name} ${CMAKE_CURRENT_BINARY_DIR}/${_name} # ensure same directory! Required by gcc
   DEPENDS ${_input}
   	VERBATIM
  )

...
if "%3" == "ALL" (
	msbuild /p:Configuration=Debug /p:"VCBuildAdditionalOptions= /useenv" %2
) else (
	msbuild /p:Configuration=Debug /p:"VCBuildAdditionalOptions= /useenv" /t:%3 %2
)
if %ERRORLEVEL% NEQ 0 goto error

set LIB=%PLIB%;..\..\%4\Release;..\%4\Release
if "%3" == "ALL" (
	msbuild /p:Configuration=Release /p:"VCBuildAdditionalOptions= /useenv" %2
) else (
	msbuild /p:Configuration=Release /p:"VCBuildAdditionalOptions= /useenv" /t:%3 %2
)
if %ERRORLEVEL% NEQ 0 goto error
